...
it('click on sign in', () => {
  cy.get('.right > a:nth-child(1)').click();
  cy.get('.wrap > nav:nth-child(2) > ul:nth-child(1) > li:nth-child(1) > a:nth-child(1)').click();
  cy.get('.right > a:nth-child(1)').click();
  cy.get('#username').type('alex@test.com');
  cy.get('#password').type('test');
  cy.get('.submit').click();
  cy.get('#join').click();
  cy.get('#firstname').type('alex');
  cy.get('#lastname').type('alex');
